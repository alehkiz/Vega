...
class TransactionForm(FlaskForm):
    ...
    finalyties = QuerySelectMultipleField('Finalidade', allow_blank=False, query_factory= lambda : TransactionFinality.query, get_label='name', validators=[DataRequired('Item Obrigatório')])
